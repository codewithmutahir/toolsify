...
export default function AllToolsPage() {
  ...
  const { tools: localizedTools, categories: localizedCategories, searchTools } =
    useLocalizedToolCatalog();
  ...
  const filteredTools = useMemo(() => {
    ...
    const categoryFiltered = localizedTools.filter(
  ...
  }, [activeCategory, searchTerm, localizedTools, searchTools]);
    ...
    <main>
      <section className="max-w-container-max mx-auto px-gutter pt-xl pb-lg text-center">
        ...
        <p className="font-body text-body text-on-surface-variant max-w-2xl mx-auto">
          {t("description", { count: localizedTools.length })}
        </p>
      </section>
      ...
      <section className="max-w-container-max mx-auto px-gutter py-xl">
        {filteredTools.length > 0 ? (
          ...
          <div className="text-center py-2xl">
            ...
            <p className="font-h3 text-h3 text-on-surface mb-xs">
              {t("noToolsFound")}
            </p>
